...
> **חיקוי מינימלי וחכם ל-[NotebookLM](https://notebooklm.google.com/) של Google**, המתמקד בשלב **איסוף וסינון המידע**.  
> סוכן (Agent) אוטונומי שמחפש מקורות ברשת, מציע אותם לבחירת המשתמש (**Human in the Loop**), ומפיק סיכום מקיף על בסיס המקורות שאושרו.
...
| :--- | :--- | :--- |
| **LangChain** | [LangChain Docs](https://docs.langchain.com/) | בניית ה-Agent (`create_agent`) |
| **Tavily** | [Tavily Search](https://tavily.com/) | מנוע חיפוש אינטרנטי שנבנה במיוחד עבור Agents |
| **Google Gemini** | [Google AI Studio](https://ai.google.dev/) | מודל השפה (המוח של ה-Agent) |
| **LangGraph** | [LangGraph Docs](https://langchain-ai.github.io/langgraph/) | זיכרון (Checkpointer) ו-Human in the Loop |
| **Streamlit** | [Streamlit Framework](https://streamlit.io/) | ממשק המשתמש |
